  ...
  <html lang="en">
    ...
    <body>
      <div class="container-fluid d-flex justify-content-center align-items-center border vh-100">
          <div class="card w-25 d-flex justify-content-center">
              <div class="card-header"><Strong>Login</Strong>
                  <div class="card-body">
                      ...
                      <form action="/ceklogin" method="POST">
                          ...
                          <span class="d-flex justify-content-center"><strong>ATAU</strong></span>

                          <a href="/register" class="btn btn-success btn-block mt-4">Register</a>
